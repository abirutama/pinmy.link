...
<body>
    <div class="" style="max-width:600px; padding:0px; margin:auto;border-radius:0px 0px 0px 48px !important; padding-bottom:8px;">
        <section id="cover" class="">
            <div class="has-text-centered" style="padding:64px 32px;border-radius:0px 0px 128px 128px !important; background-size:cover;<?= 'background-image:url(\''.base_url().'/assets/img/layout/bg1.jpg\')';  ?>">
